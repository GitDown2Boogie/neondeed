...
export default function App(){
  ...
  return(
    <div style={s.page}>
      <div style={s.header}><div><div style={s.title}>📜 NeonDeed</div><div style={{fontSize:13,color:"#64748b"}}>On-chain deed registry • {total?.toString()??0} deeds</div></div><ConnectButton/></div>
